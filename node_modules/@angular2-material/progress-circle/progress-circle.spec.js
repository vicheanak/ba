...
testing_1.describe('MdProgressCircular', function () {
    ...
    testing_1.it('should define a default value of undefined for the value attribute', function (done) {
        builder
            .overrideTemplate(TestApp, '<md-progress-circle></md-progress-circle>')
            .createAsync(TestApp)
            .then(function (fixture) {
            fixture.detectChanges();
            var progressElement = getChildDebugElement(fixture.debugElement, 'md-progress-circle');
            testing_1.expect(progressElement.componentInstance.value).toBeUndefined();
            done();
        });
    });
    testing_1.it('should set the value to undefined when the mode is set to indeterminate', function (done) {
        builder
            ...
            fixture.detectChanges();
            testing_1.expect(progressElement.componentInstance.value).toBe(50);
            fixture.debugElement.componentInstance.mode = 'indeterminate';
            fixture.detectChanges();
            testing_1.expect(progressElement.componentInstance.value).toBe(undefined);
            done();
        });
    });
    ...
    testing_1.it('should clean up the indeterminate animation when the element is destroyed', function (done) {
        ...
        builder
            ...
            fixture.detectChanges();
            var progressElement = getChildDebugElement(fixture.debugElement, 'md-progress-circle');
            testing_1.expect(progressElement.componentInstance.interdeterminateInterval).toBeTruthy();
            fixture.debugElement.componentInstance.isHidden = true;
            fixture.detectChanges();
            testing_1.expect(progressElement.componentInstance.interdeterminateInterval).toBeFalsy();
            done();
        });
    });
});
